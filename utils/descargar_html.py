...
def generar_html_familia(nombre_familia, resultados_familia):
    ...
    for nombre_estr, datos_estr in estructuras.items():
        ...
        secciones.append(f'<h2 style="margin-top:60px; border-top:3px solid #0d6efd; padding-top:20px;">{titulo}</h2>')
...
def generar_seccion_costeo_familia(costeo_global, estructuras):
    ...
    html = ['<h2 style="margin-top:60px; border-top:3px solid #198754; padding-top:20px;">COSTEO GLOBAL</h2>']
