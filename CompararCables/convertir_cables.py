...
def convertir_cables():
    ...
    with open('CompararCABLES.json', 'r', encoding='utf-8') as f:
        ...
        cable_compatible = {
            ...
            'datos_originales': {
                ...
                'mecanicas': {
                    ...
                    'peso_acero_lbs_kft': float(mec['Peso_Acero_lbs_kft']),
                    'porcentaje_peso_al': float(mec['Porcentaje_Peso_Al_lbs_kft'].replace('%', '')),
                    'porcentaje_peso_acero': float(mec['Porcentaje_Peso_Acero_lbs_kft'].replace('%', '')),
                ...
                'electricas': {
                    ...
                    'ampacidad_75c_std': float(elec['Ampacidad_75C_STD_ohm_kft']),
                    'ampacidad_75c_ex3': float(elec['Ampacidad_75C_EX3']),
